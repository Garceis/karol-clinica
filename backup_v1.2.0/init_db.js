...
const insertAdmin = db.prepare('INSERT INTO admin_users (nome, email, senha_hash) VALUES (?, ?, ?)');
insertAdmin.run('Dra. Karol Silva', 'karol@clinica.com', senhaHash);
console.log('Usuário admin padrão criado: karol@clinica.com / 123456');
